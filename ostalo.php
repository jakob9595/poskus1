...
<div class="glavni_del">
    <h1 class="naslov">Ostalo</h1>
    
    <?php
    $selekcije = [
        ['ime' => 'Novice', 'link' => 'novice.php', 'barva' => '#4682B4'],
        ['ime' => 'Dogodki', 'link' => 'dogodki.php', 'barva' => '#FFA500'],
        ['ime' => 'Vodstvo kluba', 'link' => 'trenerji.php', 'barva' => '#4682B4'],
    ];
    ?>
