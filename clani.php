<?php
    ...
    try {
        ...
        // Pridobi trenerje za to selekcijo
    ...
    <?php if (isset($_SESSION['admin']) && $_SESSION['admin']): ?>
        <div class="admin-controls">
            ...
            <div class="admin-buttons">
                <a href="dodaj_igralca.php?selekcija=clani" class="admin-btn">Dodaj novega igralca</a>
            ...
            <form id="delete-form" action="izbrisi_igralce.php" method="post" style="display: none;">
                <input type="hidden" name="redirect" value="clani.php">
        ...
        <div class="admin-controls">
            ...
            <div class="admin-buttons">
                <a href="dodaj_trenerja.php?selekcija=clani&redirect=clani.php" class="admin-btn">Dodaj novega trenerja</a>
